...
import static cleancode.minesweeper.tobe.position.RelativePositon.SURROUNDED_POSITIONS;
...
public class GameBoard {
    ...
    public void openSurroundedCells(CellPosition cellPosition) {
        if (cellPosition.isRowIndexMoreThanOrEqualTo(getRowSize()) ||
            cellPosition.isColIndexMoreThanOrEqualTo(getColSize())) {
            return;
        }
    ...
    public boolean isInvalidCellPosition(CellPosition cellPosition) {
        ...
        return cellPosition.isRowIndexMoreThanOrEqualTo(rowSize) ||
            cellPosition.isColIndexMoreThanOrEqualTo(colSize);
    }
